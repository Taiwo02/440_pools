...
const Navbar = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      icon: <RiRunLine />,
      href: "/categories/sportswear-outdoor-apparel",
    },
    {
      name: "Jewelry, Eyewear & Watches",
      icon: <RiVipDiamondLine />,
      href: "/categories/jewelry-eyewear-watches",
    },
    {
      name: "Shoes & Accessories",
      icon: <RiFootprintLine />,
      href: "/categories/shoes-accessories",
    },
    {
      name: "Packaging & Printing",
      icon: <RiPrinterLine />,
      href: "/categories/packaging-printing",
    },
    {
      name: "Parents, Kids & Toys",
      icon: <RiParentLine />,
      href: "/categories/parents-kids-toys",
    },
    {
      name: "Personal Care & Home Care",
      icon: <RiHeartPulseLine />,
      href: "/categories/personal-care-home-care",
    },
    {
      name: "Health & Medical",
    ...
    },
    {
      ...
      icon: <RiBook2Line />,
      href: "/categories/school-office-supplies",
    },
    {
    ...
    },
    {
      ...
      icon: <RiStore2Line />,
      href: "/categories/commercial-equipment-machinery",
    },
    {
      name: "Construction & Building Machinery",
      icon: <RiBuildingLine />,
      href: "/categories/construction-building-machinery",
    },
    {
      name: "Construction & Real Estate",
      icon: <RiHome4Line />,
      href: "/categories/construction-real-estate",
    },
    { name: "Furniture", icon: <RiSofaLine />, href: "/categories/furniture" },
    {
      name: "Lights & Lighting",
      icon: <RiLightbulbLine />,
      href: "/categories/lights-lighting",
    },
    {
    ...
    },
    {
      ...
      icon: <RiCarLine />,
      href: "/categories/automotive-supplies-tools",
    },
    {
      name: "Vehicle Parts & Accessories",
      icon: <RiCarWashingLine />,
      href: "/categories/vehicle-parts-accessories",
    },
    {
      name: "Tools & Hardware",
      icon: <RiToolsLine />,
    ...
    },
    {
      ...
      icon: <RiLeafLine />,
      href: "/categories/renewable-energy",
    },
    {
      name: "Electrical Equipment & Supplies",
      icon: <RiPlugLine />,
      href: "/categories/electrical-equipment-supplies",
    },
    {
      name: "Safety & Security",
      icon: <RiShieldCheckLine />,
      href: "/categories/safety-security",
    },
    {
      name: "Testing Instrument & Equipment",
      icon: <RiTestTubeLine />,
      href: "/categories/testing-instrument-equipment",
    },
    {
      name: "Power Transmission",
      icon: <RiSettingsLine />,
      href: "/categories/power-transmission",
    },
    {
    ...
    },
    {
      ...
      icon: <RiBusLine />,
      href: "/categories/vehicles-transportation",
    },
    {
      name: "Agriculture, Food & Beverage",
      icon: <RiPlantLine />,
      href: "/categories/agriculture-food-beverage",
    },
    {
      name: "Raw Materials",
      icon: <RiBox3Line />,
    ...
    },
    {
      ...
      icon: <RiServiceLine />,
      href: "/categories/fabrication-services",
    },
    ...
    <>
      ...
      >
        ...
        <div className="border-b border-(--border-default) bg-(--bg-surface) lg:hidden">
          <div className="flex items-center justify-between gap-2 px-3 pt-2.5 pb-2 shadow">
        ...
        <AnimatePresence>
          {isVisible && !hideCheckoutChrome && (
            ...
            >
              ...
              <motion.h2 className="text-lg mt-3" variants={item}>
                Categories
              </motion.h2>
